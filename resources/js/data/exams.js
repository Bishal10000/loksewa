import { serviceMeta } from './services';
...
const serviceAdministrationTopics = [
...
const servicePaperPrasasan = {
  number: 4,
  name: 'Paper 4 Group - Administration',
  type: 'subjective',
  totalMarks: 100,
  duration: '3 hr',
...
const servicePaperLekha = {
  number: 4,
  name: 'Paper 4 Group - Accounts / Audit',
  type: 'subjective',
  totalMarks: 100,
  duration: '3 hr',
...
const servicePaperPararastra = {
  number: 4,
  name: 'Paper 4 Group - Foreign Affairs',
  type: 'subjective',
  totalMarks: 100,
  duration: '3 hr',
...
const servicePaperNyaya = {
  number: 4,
  name: 'Paper 4 Group - Judicial Studies',
  type: 'subjective',
  totalMarks: 100,
  duration: '3 hr',
...
const servicePaperSansad = {
  number: 4,
  name: 'Paper 4 Group - Parliamentary Studies',
  type: 'subjective',
  totalMarks: 100,
  duration: '3 hr',
...
const naSuSubjective = {
  number: 2,
  name: 'Paper 2 and Service Laws',
  type: 'subjective',
  totalMarks: 100,
  duration: '3 hr',
  topics: [
...
const naSuServicePaper = {
  number: 3,
  name: 'Paper 3 Group - Unified Subject',
  type: 'subjective',
  totalMarks: 100,
  duration: '3 hr',
  topics: [
...
const kharidarPapers = [
  {
    number: 1,
    name: 'Paper 1 Objective - GK & Office Skills',
    type: 'objective',
    totalMarks: 100,
    duration: '1 hr 30 min',
    topics: [
  ...
  {
    number: 2,
    name: 'Paper 2 and Service Awareness',
    type: 'subjective',
    totalMarks: 100,
    duration: '3 hr',
    topics: governanceTopics,
  ...
  {
    number: 3,
    name: 'Paper 3 Management and Service Group Subject',
    type: 'subjective',
    totalMarks: 100,
    duration: '3 hr',
    topics: serviceAdministrationTopics,
...
export const exams = [
  ...
  },
  {
    ...
    passingCriteria: 'New 2081/82 rule 1 passing score is 45/100 and Paper 1 marks are not merged into the Paper 2 total.',
  ...
  },
  {
    ...
    papers: [
      { ...objectivePaper, name: 'Paper 1 Aptitude', topics: technicalTopics },
      { ...governancePaper, name: 'Paper 2 Administration', topics: serviceAdministrationTopics },
    ],
    finalStage: {
      hasComputerTest: false,
      interviewMarks: '20 marks',
  ...
  },
  {
    ...
    services: [{ slug: 'technical', nameNepali: 'प्राविधिक', nameEnglish: 'Technical' }],
    papers: [
      { ...objectivePaper, name: 'Paper 1 and GK Objective', topics: computerTopics },
      { ...governancePaper, name: 'Paper 2 Procedures and Service Delivery', topics: serviceAdministrationTopics },
    ],
    finalStage: {
      hasComputerTest: true,
  ...
  },
  {
    ...
    papers: [
      { ...objectivePaper, name: 'Paper 1 and Policy Objective', topics: governanceTopics },
      { ...contemporaryPaper, name: 'Paper 2 Quality and Contemporary Education Issues', topics: contemporaryTopics },
      { ...servicePaperPrasasan, name: 'Paper 3 Practice and Service Administration', topics: serviceAdministrationTopics },
    ],
    finalStage: {
      hasComputerTest: false,
      interviewMarks: '20 marks',
  ...
  },
  {
    ...
    papers: [
      { ...objectivePaper, name: 'Paper 1 Aptitude and GK', topics: technicalTopics },
      { ...governancePaper, name: 'Paper 2 Governance and Public Systems', topics: governanceTopics },
      { ...contemporaryPaper, name: 'Paper 3 Data and Development Issues', topics: contemporaryTopics },
    ],
    finalStage: {
      hasComputerTest: false,
      interviewMarks: '20 marks',
  ...
  },
  {
    ...
    papers: [
      { ...objectivePaper, name: 'Paper 1 Basics and GK', topics: technicalTopics },
      { ...servicePaperPrasasan, name: 'Paper 2 Administration and Service Procedures', topics: serviceAdministrationTopics },
    ],
    finalStage: {
      hasComputerTest: false,
      interviewMarks: '20 marks',
  ...
  },
  {
    ...
    papers: [
      { ...objectivePaper, name: 'Paper 1 Aptitude', topics: technicalTopics },
      { ...governancePaper, name: 'Paper 2 Works and Project Governance', topics: governanceTopics },
      { ...servicePaperPrasasan, name: 'Paper 3 Delivery and Field Execution', topics: serviceAdministrationTopics },
    ],
    finalStage: {
      hasComputerTest: false,
      interviewMarks: '20 marks',
